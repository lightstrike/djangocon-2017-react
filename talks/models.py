...
# Add Vote, Comment and Events model (and maybe tags?)
class Vote(models.Model):
    """
    Records user votes about talks.
    In this case, upvote or downvote.
    """
    user = models.ForeignKey('accounts.User', on_delete=models.CASCADE, related_name="user_votes")
    talk = models.ForeignKey('talks.Talk', on_delete=models.CASCADE, related_name="talk_votes")
